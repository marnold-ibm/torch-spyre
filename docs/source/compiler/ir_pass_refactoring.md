...
It's analogous to `matching_dim` in in `views.py` which maps coordinate expressions to host dims  (maybe they should both have names with parallel structure?)
