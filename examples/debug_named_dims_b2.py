...
def fn(queries: torch.Tensor, scale: float):
    ...
    return queries.permute(0, 2, 1, 3) * scale
...
if __name__ == "__main__":
    ...
    assert get_last_output_named_dims() == ["B", "H", "Lq", "D"], f"Case B2: got {get_last_output_named_dims()}"
    print("Case B2 done, shape:", out.shape, "ASSERTIONS PASSED")
